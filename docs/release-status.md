...
**当前具体阻断**：OpenCV 5.0.0.93 的现有 wheel 静态包含 Intel IPP 2026.0.0，其条款存在与所选 AGPL 组合路线的兼容性风险。建议确认无 IPP 的源码构建路线后，再补完其余原生依赖材料、重建和验收。详见[分发核对记录](distribution-licensing.md)。本轮未产生新版安装器或公开二进制下载，旧 44/4/2 测试结果不冒充新版验收。
